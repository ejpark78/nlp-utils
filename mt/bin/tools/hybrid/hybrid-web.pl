...
main: {
	...
	# print STDERR "# init_svm_scale\n";
	# my ($STDIN_SVM_SCALE, $STDOUT_SVM_SCALE) = init_svm_scale("", \%pid);

	# $daemon{"STDIN_SVM_SCALE"} = $STDIN_SVM_SCALE;
	# $daemon{"STDOUT_SVM_SCALE"} = $STDOUT_SVM_SCALE;
