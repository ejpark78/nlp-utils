...
sub_category = [
    ...
    {'category': 'society', 'task_id': 'incident', "사회/사건사고"},
    {'category': 'society', 'task_id': 'education', "사회/교육"},
    {'category': 'society', 'task_id': 'labor', "사회/노동"},
    {'category': 'society', 'task_id': 'media', "사회/언론"},
    {'category': 'society', 'task_id': 'environment', "사회/환경"},
    {'category': 'society', 'task_id': 'human-right', "사회/인권복지"},
    {'category': 'society', 'task_id': 'medical', "사회/식품의료"},
    {'category': 'society', 'task_id': 'local', "사회/지역"},
    {'category': 'society', 'task_id': 'person', "사회/인물"},
    {'category': 'society', 'task_id': 'etc', "사회/사회일반"},

    {'category': 'weather', 'task_id': 'weather', 'name': "날씨"},

    {'category': 'sports', 'task_id': 'baseball', "스포츠/야구"},
    {'category': 'sports', 'task_id': 'wbaseball', "스포츠/해외야구"},
    {'category': 'sports', 'task_id': 'game', "스포츠/게임"},
    {'category': 'sports', 'task_id': 'football', "스포츠/축구"},
    {'category': 'sports', 'task_id': 'wfootball', "스포츠/해외축구"},
    {'category': 'sports', 'task_id': 'basketball', "스포츠/농구"},
    {'category': 'sports', 'task_id': 'volleyball', "스포츠/배구"},
    {'category': 'sports', 'task_id': 'golf', "스포츠/골프"},
    {'category': 'sports', 'task_id': 'etc', "스포츠/스포츠-일반"},
]
