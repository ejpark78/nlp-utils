...
# c.NotebookApp.certfile = '/etc/ssl/star.ncsoft.com_cert.pem'
...
# c.NotebookApp.keyfile = '/etc/ssl/star.ncsoft.com_key.key'
...
## 
# c.MappingKernelManager.root_dir = '/workspace'
